...
interface EligiblePlayer {
  ...
  sport: string;
  holdings?: HoldingsWithPower[]; // Individual holdings breakdown (for UI selector)
}
                        ...
                        <div key={ep.holdingId || ep.playerId}>
                          ...
                          {isExpanded && hasHoldings && canBoost && (
                            <div className="bg-muted/30 px-3 pb-3">
                                      ...
                                      >
                                        ...
                                        <td className="py-2 pr-1 text-right">
                                          <Button
                                            ...
                                            onClick={() =>
                                              setSelectedHoldingId(isSelected ? null : holding.id)
                                            }
                                          >
                              ...
                              {selectedHoldingId &&
                                playerHoldings.find((h) => h.id === selectedHoldingId) && (
