          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Breaking sports news & your personalized digest
              </p>
            </div>
          </div>
            ...
            {!isAuthenticated ? (
              ...
              <div className="space-y-4">
                ...
                <p className="text-xs text-center text-muted-foreground">
                  Last generated:{" "}
                  {formatDistanceToNow(new Date(digestData.digest.generatedAt), {
                    addSuffix: true,
                  })}
                </p>
              </div>
