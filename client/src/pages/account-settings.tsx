        ...
        <header className="rounded-panel border border-border-subtle bg-surface p-5 shadow-low sm:p-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <h1 className="mt-1 text-2xl font-black tracking-tight text-content-strong">
                Settings
              </h1>
              <p className="mt-2 text-sm leading-6 text-content-muted">
                Manage notifications, device access, connected applications, and account lifecycle
                controls.
              </p>
            </div>
          </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-6 text-content-muted">
                      Review or revoke ChatGPT, Codex, and other OAuth connections authorized for
                      this account.
                    </p>
                  </div>
                </div>
                <Button asChild variant="outline" className="gap-2 sm:shrink-0">
                  <a href="/oauth/connected-apps/">
                    Manage access
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-6 text-content-muted">
                      Request permanent removal of account access and associated personal data,
                      subject to disclosed retention requirements.
                    </p>
                  </div>
                </div>
