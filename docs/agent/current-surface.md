...
- Normal conversational economic mutations remain confirmation-gated. Saved live strategies may auto-execute only the approved on-platform gameplay action set inside saved guardrails.
...
Hermes can stage, for confirmation:
