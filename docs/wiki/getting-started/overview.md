...
- **Stacked shares**: player shares with higher multiplier strength, mainly important for boosts.
...
6. Before lock, review the Boosts page to see whether any holdings should be used in boosts.
...
- **Convert**: stack raw inventory if a higher-multiplier share is more valuable than extra quantity.
...
- **Boosts**: stack shares, daily boosts, community boosts, and payout tracking.
...
- Read [Stacking Shares and Boosts](/wiki/gameplay/stacking-shares-and-boosts) before burning valuable inventory.
