# ADR 0001: Route and storage modularization for development loops
...
plan-implement-test loops slower and riskier for both humans and automated development tools.
