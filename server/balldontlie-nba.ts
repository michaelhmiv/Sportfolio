...
export async function fetchActivePlayers(): Promise<NBAPlayer[]> {
  ...
  do {
    ...
    try {
      ...
      console.log(
        `[NBA API] Fetched page ${pageCount}: ${players.length} players (total: ${allPlayers.length})`,
      );
    } catch (error: any) {
...
export async function fetchPlayerInjuries(): Promise<NBAPlayerInjuriesResult> {
  ...
  do {
    ...
    try {
      ...
      console.log(
        `[NBA API] Fetched page ${pageCount}: ${injuries.length} injuries (total: ${allInjuries.length})`,
      );
    } catch (error: any) {
 ...
 */
export function transformBoxScoreToLiveStats(
  gameId: string,
