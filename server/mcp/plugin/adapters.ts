...
export const PLUGIN_TOOL_ADAPTERS: readonly PluginToolAdapter[] = [
  {
    ...
    description:
      "Use when the user asks how Sportfolio works or needs help finding a documented rule. Returns matching public documentation. Do not use for connected-account data.",
  },
  {
    ...
    description:
      "Use after identifying a documentation article. Returns one public Sportfolio guide. Do not use for player or account information.",
  },
  {
    name: "search_players",
    ...
    description:
      "Use to resolve a player by name, team, position, or sport. Returns public player matches. Do not use to inspect the connected user's holdings.",
  },
  {
    ...
    description:
      "Use for a specific player's public Sportfolio profile, performance, and market context. Do not use to execute a trade.",
  },
  {
    ...
    description:
      "Use for a specific player's recent game log. Returns bounded recent performance data. Do not use for all games on a date.",
  },
  {
    name: "get_games",
    ...
    description:
      "Use for Sportfolio-supported games on a date or in a sport. Returns game schedule and status information. Do not use for the user's personalized lineup impact.",
  },
  {
    ...
    description:
      "Use for a broad connected-account overview spanning the user's virtual portfolio, balance, boosts, scouts, and watchlists.",
  },
  {
    ...
    description:
      "Use when the connected user asks about virtual holdings, concentration, or portfolio status. This is not financial investment data.",
  },
  {
    ...
    description:
      "Use for historical snapshots or virtual performance over a supported time range. Do not present virtual changes as real-money gains or losses.",
  },
  {
    name: "get_my_balance",
    ...
    description:
      "Use for the connected user's virtual Sportfolio balance and capacity state. The balance has no cash value and cannot be withdrawn.",
  },
  {
    ...
    description:
      "Use to list the connected user's saved player watchlists. This tool does not create, edit, or delete watchlists.",
  },
  {
    ...
    description:
      "Use after a watchlist is identified to list its player items. This tool is read-only.",
  },
  {
    ...
    description:
      "Use to review the connected user's daily virtual boosts for a date. This tool cannot assign or remove boosts.",
  },
  {
    ...
    description:
      "Use for recent virtual boost results and payouts. Returns bounded history and does not modify boosts.",
  },
  {
    ...
    description:
      "Use to review collection progress for the connected account. Returns tracked virtual collection state.",
  },
  {
    ...
    description:
      "Use for one identified collection to review progress and owned players. This tool does not alter allocations.",
  },
  {
    ...
    description:
      "Use to review the connected user's Sportfolio milestone progress. This tool does not claim or celebrate milestones.",
  },
  {
    ...
    description:
      "Use to connect scheduled games with the user's holdings and virtual boosts. This is personalized read-only gameplay analysis.",
  },
  {
    ...
    description:
      "Use to rank read-only candidate ideas for the user's daily virtual boosts. This tool cannot assign a boost.",
  },
  {
    ...
    description:
      "Use to identify read-only scouting opportunities for the connected account. This tool cannot scout or allocate shares.",
  },
] as const;
